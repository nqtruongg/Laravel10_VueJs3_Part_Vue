...
onMounted(async () => {
  ...
  console.log(data);
  // Đoạn mã này sử dụng Vue và onMounted để gọi hàm allTasks khi component được gắn kết lên DOM. Sau đó, nó lấy dữ liệu trả về từ API và hiển thị nó trong console.
